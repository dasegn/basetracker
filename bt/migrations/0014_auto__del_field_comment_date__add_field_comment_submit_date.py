...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'bt_comment', 'date')

        # Adding field 'Comment.submit_date'
        db.add_column(u'bt_comment', 'submit_date',
    ...
    def backwards(self, orm):
        ...
        db.add_column(u'bt_comment', 'date',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now),
                      keep_default=False)

        # Deleting field 'Comment.submit_date'
        db.delete_column(u'bt_comment', 'submit_date')
    ...
    models = {
        ...
        'bt.comment': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'submit_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.date.today'}),
