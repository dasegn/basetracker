...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'bt_task', 'priority_id')

        # Adding field 'Task.tstatus'
        db.add_column(u'bt_task', 'tstatus',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='task_with_status', null=True, to=orm['bt.Attribute']),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Task.priority'
        db.add_column(u'bt_task', 'priority',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='task_with_priority', null=True, to=orm['bt.Attribute']),
                      keep_default=False)

        # Deleting field 'Task.tstatus'
        db.delete_column(u'bt_task', 'tstatus_id')
    ...
    models = {
        ...
        'bt.task': {
            'Meta': {'ordering': "['tstatus']", 'object_name': 'Task'},
