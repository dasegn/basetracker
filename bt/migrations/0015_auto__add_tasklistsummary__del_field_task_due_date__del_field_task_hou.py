...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'TaskListSummary'
        db.create_table(u'bt_tasklistsummary', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('list', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['bt.TaskList'])),
            ('assigned', self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='tasklist_assigned_to', to=orm['auth.User'])),
            ('hours', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=5, decimal_places=2)),
        ))
        db.send_create_signal('bt', ['TaskListSummary'])

        # Deleting field 'Task.due_date'
        db.delete_column(u'bt_task', 'due_date')

        # Deleting field 'Task.hours'
        db.delete_column(u'bt_task', 'hours')

        # Deleting field 'Task.assigned_to'
        db.delete_column(u'bt_task', 'assigned_to_id')


        # Changing field 'Task.created_by'
        db.alter_column(u'bt_task', 'created_by_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth.User']))

    def backwards(self, orm):
        # Deleting model 'TaskListSummary'
        db.delete_table(u'bt_tasklistsummary')

        # Adding field 'Task.due_date'
        db.add_column(u'bt_task', 'due_date',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Task.hours'
        db.add_column(u'bt_task', 'hours',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=5, decimal_places=2),
                      keep_default=False)

        # Adding field 'Task.assigned_to'
        db.add_column(u'bt_task', 'assigned_to',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='task_assigned_to', to=orm['auth.User'], blank=True),
                      keep_default=False)


        # Changing field 'Task.created_by'
        db.alter_column(u'bt_task', 'created_by_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['auth.User']))
    ...
    models = {
        ...
        'bt.tasklist': {
            'Meta': {'ordering': "['name', 'tstatus']", 'object_name': 'TaskList'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'tstatus': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'task_with_status'", 'null': 'True', 'to': "orm['bt.Attribute']"})
        },
        'bt.tasklistsummary': {
