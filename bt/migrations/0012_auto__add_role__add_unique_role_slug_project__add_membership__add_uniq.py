...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Role'
        db.create_table(u'bt_role', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('slug', self.gf('django.db.models.fields.SlugField')(max_length=250, blank=True)),
            ('project', self.gf('django.db.models.fields.related.ForeignKey')(related_name='roles', null=True, to=orm['bt.Project'])),
        ))
        db.send_create_signal('bt', ['Role'])

        # Adding unique constraint on 'Role', fields ['slug', 'project']
        db.create_unique(u'bt_role', ['slug', 'project_id'])

        # Adding model 'Membership'
        db.create_table(u'bt_membership', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='memberships', null=True, blank=True, to=orm['auth.User'])),
            ('project', self.gf('django.db.models.fields.related.ForeignKey')(related_name='memberships', to=orm['bt.Project'])),
            ('role', self.gf('django.db.models.fields.related.ForeignKey')(related_name='memberships', to=orm['bt.Role'])),
        ))
        db.send_create_signal('bt', ['Membership'])

        # Adding unique constraint on 'Membership', fields ['user', 'project']
        db.create_unique(u'bt_membership', ['user_id', 'project_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Membership', fields ['user', 'project']
        db.delete_unique(u'bt_membership', ['user_id', 'project_id'])

        # Removing unique constraint on 'Role', fields ['slug', 'project']
        db.delete_unique(u'bt_role', ['slug', 'project_id'])

        # Deleting model 'Role'
        db.delete_table(u'bt_role')

        # Deleting model 'Membership'
        db.delete_table(u'bt_membership')
    ...
    models = {
        ...
        'bt.membership': {
            ...
            'user': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'related_name': "'memberships'", 'null': 'True', 'blank': 'True', 'to': u"orm['auth.User']"})
        },
        'bt.profile': {
