...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TaskList.service'
        db.add_column(u'bt_tasklist', 'service',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['bt.Service']),
                      keep_default=False)
    ...
    def backwards(self, orm):
        # Deleting field 'TaskList.service'
        db.delete_column(u'bt_tasklist', 'service_id')
    ...
    models = {
        ...
        'bt.tasklist': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'listEnd': ('django.db.models.fields.DateField', [], {'auto_now': 'True', 'null': 'True', 'blank': 'True'}),
            'listStart': ('django.db.models.fields.DateField', [], {'auto_now': 'True', 'null': 'True', 'blank': 'True'}),
