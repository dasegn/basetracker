...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'TaskList.team'
        db.delete_column(u'bt_tasklist', 'team_id')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'TaskList.team'
        raise RuntimeError("Cannot reverse this migration. 'TaskList.team' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'TaskList.team'
        db.add_column(u'bt_tasklist', 'team',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.Group']),
                      keep_default=False)
