...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'TaskList.listStart'
        db.delete_column(u'bt_tasklist', 'listStart')

        # Deleting field 'TaskList.listEnd'
        db.delete_column(u'bt_tasklist', 'listEnd')

        # Adding field 'TaskList.list_start'
        db.add_column(u'bt_tasklist', 'list_start',
                      self.gf('django.db.models.fields.DateField')(auto_now=True, null=True, blank=True),
                      keep_default=False)

        # Adding field 'TaskList.list_end'
        db.add_column(u'bt_tasklist', 'list_end',
                      self.gf('django.db.models.fields.DateField')(auto_now=True, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'TaskList.listStart'
        db.add_column(u'bt_tasklist', 'listStart',
                      self.gf('django.db.models.fields.DateField')(auto_now=True, null=True, blank=True),
                      keep_default=False)

        # Adding field 'TaskList.listEnd'
        db.add_column(u'bt_tasklist', 'listEnd',
                      self.gf('django.db.models.fields.DateField')(auto_now=True, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'TaskList.list_start'
        db.delete_column(u'bt_tasklist', 'list_start')

        # Deleting field 'TaskList.list_end'
        db.delete_column(u'bt_tasklist', 'list_end')
    ...
    models = {
        ...
        'bt.tasklist': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'list_end': ('django.db.models.fields.DateField', [], {'auto_now': 'True', 'null': 'True', 'blank': 'True'}),
            'list_start': ('django.db.models.fields.DateField', [], {'auto_now': 'True', 'null': 'True', 'blank': 'True'}),
