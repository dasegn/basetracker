...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'bt_project', 'parent_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['bt.Project'], null=True))

    def backwards(self, orm):

        # Changing field 'Project.parent'
        db.alter_column(u'bt_project', 'parent_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['bt.Project']))
