...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'bt_role', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=250, null=True))

    def backwards(self, orm):

        # Changing field 'Role.slug'
        db.alter_column(u'bt_role', 'slug', self.gf('django.db.models.fields.SlugField')(default='', max_length=250))
