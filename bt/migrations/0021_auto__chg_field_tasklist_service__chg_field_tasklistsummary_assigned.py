...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'TaskList.service'
        db.alter_column(u'bt_tasklist', 'service_id', self.gf('smart_selects.db_fields.ChainedForeignKey')(to=orm['bt.Service']))

        # Changing field 'TaskListSummary.assigned'
        db.alter_column(u'bt_tasklistsummary', 'assigned_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['bt.Membership']))

    def backwards(self, orm):

        # Changing field 'TaskList.service'
        db.alter_column(u'bt_tasklist', 'service_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['bt.Service']))

        # Changing field 'TaskListSummary.assigned'
        db.alter_column(u'bt_tasklistsummary', 'assigned_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))
