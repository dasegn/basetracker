...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'bt_team', 'order')
    ...
    models = {
        ...
        'bt.membership': {
            'Meta': {'ordering': "('project', 'user')", 'object_name': 'Membership'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'bt.task': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'list': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'tsk_item'", 'to': "orm['bt.TaskList']"}),
        ...
        'bt.tasklist': {
            ...
            'project': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'tsklst'", 'to': "orm['bt.Project']"}),
        ...
        'bt.tasklistsummary': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'list': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'tsk_member'", 'to': "orm['bt.TaskList']"})
        },
        'bt.team': {
