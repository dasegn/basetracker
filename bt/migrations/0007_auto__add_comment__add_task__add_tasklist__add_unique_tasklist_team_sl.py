...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'bt_task', (
            ...
            ('assigned_to', self.gf('django.db.models.fields.related.ForeignKey')(related_name='task_assigned_to', to=orm['auth.User'])),
    ...
    models = {
        ...
        'bt.task': {
            ...
            'assigned_to': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'task_assigned_to'", 'to': u"orm['auth.User']"}),
