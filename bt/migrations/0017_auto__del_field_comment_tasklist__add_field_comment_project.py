...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Comment.tasklist'
        db.delete_column(u'bt_comment', 'tasklist_id')

        # Adding field 'Comment.project'
        db.add_column(u'bt_comment', 'project',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['bt.Project'], null=True),
                      keep_default=False)


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Comment.tasklist'
        raise RuntimeError("Cannot reverse this migration. 'Comment.tasklist' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'Comment.tasklist'
        db.add_column(u'bt_comment', 'tasklist',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['bt.TaskList']),
                      keep_default=False)

        # Deleting field 'Comment.project'
        db.delete_column(u'bt_comment', 'project_id')
